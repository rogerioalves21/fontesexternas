...
public class RandomUserAgent {
  ...
  public static String getRandomUserAgent() {
    ...
    Logger.getLogger(RandomUserAgent.class.getName()).log(Level.INFO, String.format("Utilizando %s para requisição", userAgents[(int) Math.floor(Math.random() * userAgents.length)]));
